...
public class ImageUtils {
    ...
    public static BufferedImage drawSpeace(BufferedImage src, int size) {
        BufferedImage tag = new BufferedImage(size, size, BufferedImage.TYPE_INT_ARGB);
        Graphics2D g = tag.createGraphics();
        g.drawImage(src, (size-src.getWidth())/2, (size-src.getWidth())/2, null);
        return  tag;
    }
    
    public static BufferedImage drawBord(BufferedImage src, Color c) {
